...
It's pretty simple and was made to practice core django concepts such as working with templates, models, migrations, ORM, database etc.
Here you will find index page, goods list with pagination, cart, order page, profile and simple authorization, about page. Each page have navigation bar and mini cart icon that opens mini cart modal window.
